 ...
 * @author Qordoba
 */
class Qordoba_Connector_Block_Adminhtml_System_Config_ContentFields
    extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    
    const CONFIG_PATH = 'qordoba/';
    ...
    protected function _getConfigPath($elementId){
       $pathMap = array(
           'qordoba_cms_page_settings_fields_to_translate'     => 'cms_page_settings/fields_to_translate',
           'qordoba_cms_block_settings_fields_to_translate'    => 'cms_block_settings/fields_to_translate',
           'qordoba_product_settings_attributes_to_translate'  => 'product_settings/attributes_to_translate',
           'qordoba_category_settings_attributes_to_translate' => 'category_settings/attributes_to_translate'
       );
