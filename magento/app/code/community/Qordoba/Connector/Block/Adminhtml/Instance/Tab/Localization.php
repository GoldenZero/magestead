...
class Qordoba_Connector_Block_Adminhtml_Instance_Tab_Localization
    extends Qordoba_Connector_Block_Adminhtml_Instance_Widget
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldsetProfile->addType('profiles','Qordoba_Connector_Block_Adminhtml_Projects_Edit_Form_Element_Profiles');
