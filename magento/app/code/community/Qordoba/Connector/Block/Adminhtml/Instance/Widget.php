...
class Qordoba_Connector_Block_Adminhtml_Instance_Widget extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    public function getScript() {
        ...
        .  " var reloadurl = '" . $this->getUrl('qordoba/adminhtml_instance/profiles/type/' . $this->_formType . '/') . "filter_id/' + selectElement.value;"
