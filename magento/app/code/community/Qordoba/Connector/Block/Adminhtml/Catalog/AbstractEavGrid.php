 ...
 * @author     Qordoba
 */
abstract class Qordoba_Connector_Block_Adminhtml_Catalog_AbstractEavGrid
    extends Mage_Eav_Block_Adminhtml_Attribute_Grid_Abstract
{
     /**
     *
     * @var string - Qordoba type name
     */
    protected $_typeName;
     ...
     *
     * @return Qordoba_Connector_Block_Adminhtml_Catalog_AbstractEavGrid
     */
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('is_attached', array(
            ...
            'width' => '20px',
            'align' => 'center',
            'renderer' => 'Qordoba_Connector_Block_Adminhtml_Content_Grid_Column_Status',
            'filter' => false,
            'options' => array(
