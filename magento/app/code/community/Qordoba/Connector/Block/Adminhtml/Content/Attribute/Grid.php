 ...
 * @author Qordoba
 */
class Qordoba_Connector_Block_Adminhtml_Content_Attribute_Grid
    extends Mage_Adminhtml_Block_Catalog_Product_Attribute_Grid 
{
   
    protected $_contentTypeId = 5;
    
    protected $_contentType = Qordoba_Connector_Model_Content_Attribute::CONTENT_TYPE;
    ...
    /**
     * 
     * @return \Qordoba_Connector_Block_Adminhtml_Content_Product_Grid
     */
