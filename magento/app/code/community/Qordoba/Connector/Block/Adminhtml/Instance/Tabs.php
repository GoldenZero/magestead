...
class Qordoba_Connector_Block_Adminhtml_Instance_Tabs extends Mage_Adminhtml_Block_Widget_Tabs {

    public function __construct() {
        parent::__construct();
        $this->setId('entity_list_tabs');
        $this->setDestElementId('edit_form_container');
        $this->setTitle(Mage::helper('connector')->__('Qordoba Entities'));
    }
    ...
    protected function _beforeToHtml() {
        ...
        foreach ($entityTypes as $entityType) {
            ...
            if(!mageFindClassFile('Qordoba_Connector_Block_Adminhtml_Instance_Tab_' . ucfirst($typeCode))) {
                continue;
            }
