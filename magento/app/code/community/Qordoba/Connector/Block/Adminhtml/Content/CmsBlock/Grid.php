 ...
 * @author Qordoba
 */
class Qordoba_Connector_Block_Adminhtml_Content_CmsBlock_Grid
    extends Mage_Adminhtml_Block_Cms_Block_Grid
{
    
    protected $_contentType = Qordoba_Connector_Model_Content_CmsBlock::CONTENT_TYPE;
    ...
    /**
     * 
     * @return \Qordoba_Connector_Block_Adminhtml_Content_Grid
     */
    protected function _prepareMassaction() {
        ...
        $this->getMassactionBlock()->addItem('update', array(
            'label' => Mage::helper('connector')->__('Add To Qordoba Translations'),
    ...
    protected function _prepareCollection() {
       ...
       $qordobaProjectsLocales = $resource->getTableName('qordoba_projects_locales');
       ...
       $collection->getSelect()
               ...
               ->joinInner(
                   ...
                   array())
               ->joinLeft(
                   array('spl' => $qordobaProjectsLocales),
                   "csg.default_store_id = cbs.store_id",
                   array())
