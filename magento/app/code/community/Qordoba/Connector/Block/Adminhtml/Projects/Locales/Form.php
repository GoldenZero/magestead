 ...
 * @author Qordoba
 */
class Qordoba_Connector_Block_Adminhtml_Projects_Locales_Form
    extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    public function __construct(array $data) {
        ...
        if($this->getEntityType() && $this->getFilterId()) {
            ...
            try {
                ...
                if(($filterModel instanceof Qordoba_Connector_Model_Projects_Filter) === false) {
                    Mage::getSingleton('adminhtml/session')->addError(
                       Mage::helper('connector')->__("Application error. Please check qordoba log to see details.")
                    );
                    Mage::throwException("Class [" . $filterClass . "] must be instance of Qordoba_Connector_Model_Projects_Filter");
                }
    ...
    {
        return Mage::helper('connector')->__('Qordoba Translations');
    }
    ...
    public function getTitle() {
        return Mage::helper('connector')->__("Qordoba Translation Actions");
    }
