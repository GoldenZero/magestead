...
class Qordoba_Connector_Block_Adminhtml_Projects_Edit_Tabs_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm() {
        ...
        $fieldsetMapping->addType('store_view_label','Qordoba_Connector_Block_Adminhtml_Projects_Edit_Form_Element_StoreViewLabel');
        ...
        foreach ($storeValues as $storeId => $storeName) {
            ...
            $fieldsetMapping->addField('store_view_labels[' . $storeId . ']', 'store_view_label', array(
                ...
                'bold'      =>  true,
                'store_id' => $storeId,
                'after_element_html' => '<p class="note" style="background-position:17px; padding-left:27px"><span>' . Mage::helper('connector')->__('enter Qordoba language ID here') . '</span></p>',
