 ...
 * @author Qordoba
 */
class Qordoba_Connector_Block_Adminhtml_Catalog_Category_Tab_Translations
        ...
        implements Mage_Adminhtml_Block_Widget_Tab_Interface 
{
    ...
    protected function _prepareForm(){                      
        ...
        $fieldset = $form->addFieldset('qordoba_translation', array(
            'legend'=>Mage::helper('connector')->__('Qordoba Translation')
                ));
        
        $fieldset->addField('translation_is_active', 'select', array(
            'label'     => Mage::helper('connector')->__('Enable Qordoba Translations'),
            'title'     => Mage::helper('connector')->__('Enable Qordoba Translations'),
