...
class Qordoba_Connector_Block_Adminhtml_Projects_Edit_Form_Element_StoreViewLabel extends Varien_Data_Form_Element_Abstract
{
    ...
    public function getElementHtml()
    {
        ...
        $inputText =  $this->addField($inputTextId, 'text', array(
            ...
            'title' => Mage::helper('connector')->__('Qordoba Locale Code'),
            'no_span' => true,
