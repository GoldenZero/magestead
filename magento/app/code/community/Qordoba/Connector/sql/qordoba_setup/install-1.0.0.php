...
$installer->run("DROP TABLE IF EXISTS qordoba_content_types");
$installer->run("DROP TABLE IF EXISTS qordoba_localization_files_index");
$installer->run("DROP TABLE IF EXISTS qordoba_projects");
$installer->run("DROP TABLE IF EXISTS qordoba_projects_locales");
$installer->run("DROP TABLE IF EXISTS qordoba_translate_attributes");
$installer->run("DROP TABLE IF EXISTS qordoba_translate_content");
$installer->run("DROP TABLE IF EXISTS qordoba_translate_fields");
...
$typesTable = $installer->getConnection()
        ...
        ->addColumn('title_single', Varien_Db_Ddl_Table::TYPE_TEXT, 255, array(
            'nullable' => false,
        ), 'Title Single');
...
$table_projects = $installer->getConnection()->newTable($projectsTable)
    ...
    ->setComment('List of Qordoba Projects');
...
$table_projects_locale = $installer->getConnection()->newTable($projectsLocalesTable)
    ...
    ->setComment('List of Qordoba Projects Locales')
    ->addForeignKey(
...
$data = array(
    array(
        'type_id' => 1,
        'type_name' => Qordoba_Connector_Model_Content_CmsPage::CONTENT_TYPE,
    ...
    array(
        'type_id' => 2,
        'type_name' => Qordoba_Connector_Model_Content_CmsBlock::CONTENT_TYPE,
    ...
    array(
        'type_id' => 3,
        'type_name' => Qordoba_Connector_Model_Content_Product::CONTENT_TYPE,
    ...
    array(
        'type_id' => 4,
        'type_name' => Qordoba_Connector_Model_Content_Category::CONTENT_TYPE,
    ...
    array(
        'type_id' => 5,
        'type_name' => Qordoba_Connector_Model_Content_Attribute::CONTENT_TYPE,
    ...
    array(
        'type_id' => 6,
        'type_name' => Qordoba_Connector_Model_Content_Localization::CONTENT_TYPE,
        'model'     => 'connector/content_localization',
        'title'     => 'Localization Files',
        'title_single' => 'Localization File'
    )
);
