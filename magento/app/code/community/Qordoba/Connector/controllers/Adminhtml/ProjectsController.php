 ...
 * @author Qordoba
 */
class Qordoba_Connector_Adminhtml_ProjectsController extends Mage_Adminhtml_Controller_Action
{
    ...
    protected function _initAction() {
        $this->_title($this->__('Qordoba'))
                ->_title($this->__('Projects'));

        $this->loadLayout()->_setActiveMenu('qordoba/projects');
        ...
        if (!empty($data)) {
            ...
            try {
                ...
                if (!sizeof($locale_data)) {
                    Mage::throwException($this->__('You should choose at less one locale and enter appropriate Qordoba locale code'));
                }
