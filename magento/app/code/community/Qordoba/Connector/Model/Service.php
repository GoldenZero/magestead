 ...
 * @author Qordoba
 */
class Qordoba_Connector_Model_Service
    extends Mage_Core_Model_Abstract
{
     ...
     * Lock file name
     */
    protected $_lockFileName = 'qordoba_check_status_process.lock';
     ...
     * 
     * @param string $uri
     * @return \Qordoba_Connector_Model_CallUpload
     */
    ...
    public function callUpload($content_id = 0) {   
        ...
        /** @var $contentType Qordoba_Connector_Model_Content */
        ...
        foreach($collection as $item) {
            ...
            /** @var $contentModel Qordoba_Connector_Model_Content_Abstract */
            $contentModel = Mage::getModel($item['model']);
            
            try { 

                if(($contentModel instanceof Qordoba_Connector_Model_Content_Abstract) == false) {
                ...
                if ($responseSuccessStatus) { 
                    ...
                    $status = Qordoba_Connector_Model_Content::CONTENT_STATUS_PROCESS;
                    $updateData = array('content_id' => $item['content_id'],
                                        'filename'   => $item['filename'],
                                        'file_id'    => $responseSuccessStatus,
                                        'percent'    => 1,
                                        'status'     => $status,
    ...
    public function updateStatus($force = false) {
        ...
        Mage::dispatchEvent('qordoba_check_statuses_before',
                            array(
        ...
        foreach ($contentCollection as $item) {
            ...
            try {
                ...
                /** @var Qordoba_Connector_Model_Translator */
...
//                    }
                    ...
                    $item->setPercent($percent ? $percent : 1);
                    $item->save();
                }
                
                if($force === true || $percent == 100) {
                    
                    $response = $connector->downloadTranslatedContent($item['file_id'],
                                                                      $item['locale'], 
                    ...
                    Mage::dispatchEvent('qordoba_apply_content_after',
                            array(
        ...
        Mage::dispatchEvent('qordoba_check_statuses_after',
                            array(
     ...
     * @return false|\Qordoba_Connector_Model_Resource_Content_Collection
     */
     ...
     *
     * @return Qordoba_Connector_Model_Service
     */
