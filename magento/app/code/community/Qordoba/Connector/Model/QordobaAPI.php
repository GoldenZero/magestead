 ...
 * @author Qordoba
 */
require_once(Mage::getBaseDir('lib') . '/QordobaApi/lib/QordobaAPI.php');

class Qordoba_Connector_Model_QordobaAPI
    extends QordobaAPI
{
    /**
     ...
     * @var int 
     */
    protected $_mock_files_dir = 'var/qordoba/';
     ...
     * @var array 
     */
    protected $_testText = array('Qordoba test product', 'test text', 'Title');


    public function __construct($options = array()) {
       
       $this->_mock_files_dir = Mage::getBaseDir('var') . DS . 'qordoba' . DS;
       
       $this->_mock_data = Mage::getStoreConfig('dev/qordoba/mock_data');
...
//                ), $params);
    $sendData = $params;
    $uri = "projects/$this->_projectId/languages/$locale/files/$fileUri/stats";
