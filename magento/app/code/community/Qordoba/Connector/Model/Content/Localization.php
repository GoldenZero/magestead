 ...
 * @author Qordoba
 */
class Qordoba_Connector_Model_Content_Localization
        ...
        implements Qordoba_Connector_Model_Content_Interface
{
    ...
    protected $_comments = array(
            'qordoba.field_separator'=> ',',
            'qordoba.string_encloser' => '"',
            'qordoba.string_format_paths' => 'html : 2',
            'qordoba.paths' => '2',
            'qordoba.source_key_paths' => '1',
            'qordoba.placeholder_format_custom' => '(%\w{1})|(\{\{.+\}\})'
        );
     ...
     * 
     * @param Qordoba_Connector_Model_Content_Localization|int $localization
    ...
    public function uploadContent($path, $fileUri, $item) {
        ...
        /** @var $translator Qordoba_Connector_Model_Translator */
        ...
        $translator->setFileType(Qordoba_Connector_Model_Translator::FILE_TYPE_CSV);
