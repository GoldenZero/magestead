 ...
 * @author Qordoba
 */
class Qordoba_Connector_Model_Content_CmsPage_Observer
{
    ...
    public function getPageInfo(Varien_Event_Observer $cmspage){
        ...
        if (is_array($page->getData('locales'))) {
            ...
            /** @var $contentModel Qordoba_Connector_Model_Content_CmsPage */
             ...
             */
             ...
             $type = Mage::helper('connector')
                 ->findTypeIdByTypeName(Qordoba_Connector_Model_Content_CmsPage::CONTENT_TYPE);
             $processData = array(
                    'type'              => $type,
