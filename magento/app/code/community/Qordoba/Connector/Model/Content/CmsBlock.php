 ...
 * @author Qordoba
 */
class Qordoba_Connector_Model_Content_CmsBlock
        ...
        implements Qordoba_Connector_Model_Content_Interface
{
    ...
    public function createTranslateContent($cmsBlock, $project_id, $sourceStoreId) {
        ...
        if(($flatColumnsCollection instanceof Qordoba_Connector_Model_Resource_Translate_Fields_List_Block_Collection) == false ) {
    ...
    /**
     * 
     * @return \Qordoba_Connector_Model_Resource_Translate_Fields_List_Block_Collection
     */
