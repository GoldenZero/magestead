 ...
 * @author Qordoba
 */
class Qordoba_Connector_Model_Content_Product
    extends Qordoba_Connector_Model_Content_Abstract
        implements Qordoba_Connector_Model_Content_Interface,
                   Qordoba_Connector_Model_Content_EavEntityInterface
{
    ...
    /**
     * Qordoba content types
     * 
     * @var array
     */
    protected $_qordobaContentTypes = array('content', 'htmlcontent');
     ...
     * @return string
     */
    public function formatFileUri($filename, $sku, $project_id) {
        $fileUri = $filename . "_SKU-" . $sku;
        return $fileUri;
    }
     ...
     * Also defines filename uri for upload content to Qordoba via API
     * Defines content title for qordoba translation table
     * 
    ...
    public function createTranslateContent($product, $project_id, $sourceStoreId) {
        ...
        /**
         * @TODO group entities at Qordoba_Connector_ServiceController by entity type
        ...
        //create qordoba type content
        foreach ($this->_qordobaContentTypes as $type) {
        ...
        $filename = ($product->getUrlKey()) ? $product->getUrlKey() : 'product';
        $this->_fileUri = $this->formatFileUri($filename, $product->getSku(), $project_id);
