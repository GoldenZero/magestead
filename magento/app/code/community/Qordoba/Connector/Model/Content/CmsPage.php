 ...
 * @author Qordoba
 */
class Qordoba_Connector_Model_Content_CmsPage
        ...
        implements Qordoba_Connector_Model_Content_Interface
{
    ...
    public function createTranslateContent($cmsPage, $project_id, $sourceStoreId) {
        ...
        if(($flatColumnsCollection instanceof Qordoba_Connector_Model_Resource_Translate_Fields_List_Page_Collection) == false ) {
    ...
    /**
     * 
     * @return \Qordoba_Connector_Model_Resource_Translate_Fields_List_Page_Collection
     */
