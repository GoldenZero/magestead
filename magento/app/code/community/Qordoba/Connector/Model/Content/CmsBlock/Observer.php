 ...
 * @author Qordoba
 */
class Qordoba_Connector_Model_Content_CmsBlock_Observer
{
    ...
    public function sendBlockContentToTranslator(Varien_Event_Observer $object){
        ...
        if ($modelObject instanceof Mage_Cms_Model_Block){           
            if ($modelObject->getLocales() && is_array($modelObject->getLocales())){
                ...
                /** @var $contentModel Qordoba_Connector_Model_Content_CmsBlock */
                ...
                /**
                 * create and save xml content for qordoba translations
                 */
                //$content = $contentModel->createTranslateContent($modelObject);
                $type = Mage::helper('connector')
                          ->findTypeIdByTypeName(Qordoba_Connector_Model_Content_CmsBlock::CONTENT_TYPE);
                $processData = array(
                        'type'              => $type,
