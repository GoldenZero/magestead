 ...
 * @author Qordoba
 */
class Qordoba_Connector_Model_Content_Category_Observer
{
        ...
        if (is_array($category->getData('locales'))) { 
            ...
            $processData = array(
                    'type'              => Mage::helper('connector')
                                            ->findTypeIdByTypeName(Qordoba_Connector_Model_Content_Category::CONTENT_TYPE),
...
//             }       
    ...
    /**
     * Add locales params to product for sending product content to Qordoba
     * 
     * 
     * @param Varien_Event_Observer $object
     */
