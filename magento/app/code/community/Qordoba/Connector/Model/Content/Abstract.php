 ...
 * @author Qordoba
 */
abstract class Qordoba_Connector_Model_Content_Abstract
    extends Mage_Core_Model_Abstract
{
     ...
     * Holds in qordoba content table
     * 
     * @return string
     */
    ...
    public function uploadContent($content, $fileUri, $item) {
        ...
        $translator->setFileType(Qordoba_Connector_Model_Translator::FILE_TYPE_XML);
    ...
    public function getSystemDirectoryPath() {
        return Mage::getBaseDir('var') . '/qordoba/localization_files';
    }
