...
class Qordoba_Connector_Model_Resource_Log_Collection
    extends Varien_Data_Collection
{
     ...
     * @return \Qordoba_Connector_Model_Resource_Log_Collection
     */
    public function loadData($printQuery = false, $logQuery = false) {
        
        $_pageSize = $this->getPageSize();
        $_currPage = $this->getCurPage();
        $logFile = Mage::getBaseDir('var') . DS . 'log' . DS . Mage::getStoreConfig('dev/qordoba/log_file');
