 ...
 * @author Qordoba
 */
class Qordoba_Connector_Model_Types_Xml
{
     ...
     * @var string 
     */
    protected $_noTranslateComment = 'qordoba.sltrans = notranslate';
    
    /**
     *
     * @var string
     */
    protected $_translateComment = 'qordoba.sltrans = translate';
    
    /**
     *
     * @var string
     */
    protected $_translatePaths = "qordoba.translate_paths";
    
    /**
     *
     * @var string
     */
    protected $_stringFormatPaths = "qordoba.string_format_paths";
    
    /**
     * @var string
     */
    protected $_placeholderCustomName = "qordoba.placeholder_format_custom";
